...
(New-Object System.Net.WebClient).DownloadFile("https://github.com/ahmadzahoory/gcpcev2/raw/main/lab-14-01-code.zip", (Get-Location).Path + "\lab-14-01-code.zip")
$zipfile = $shell_app.Namespace((Get-Location).Path + "\lab-14-01-code.zip")
