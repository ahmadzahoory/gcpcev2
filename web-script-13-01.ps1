...
(New-Object System.Net.WebClient).DownloadFile("https://github.com/ahmadzahoory/gcpcev2/raw/main/lab-13-01-code.zip", (Get-Location).Path + "\lab-13-01-code.zip")
$zipfile = $shell_app.Namespace((Get-Location).Path + "\lab-13-01-code.zip")
