...
(New-Object System.Net.WebClient).DownloadFile("https://github.com/ahmadzahoory/gcpcev2/raw/main/lab-09-01-code-b.zip", (Get-Location).Path + "\lab-09-01-code-b.zip")
$zipfile = $shell_app.Namespace((Get-Location).Path + "\lab-09-01-code-b.zip")
